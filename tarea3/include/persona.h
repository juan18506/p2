/*
  ...
  Los elementos de tipo TPersona son elementos que almacenan un id, un nombre,
  una edad y una agenda.
...
TPersona crearTPersona(nat id, nat edad, const char nombre[100],
                       TAgendaLS agenda);

// Función para liberar la memoria asignada a una persona
// La función es Theta(n) peor caso, donde n es la cantidad de eventos en la
...
// [agenda de la persona]
// Por ejemplo, si tenemos a la persona "Persona1" con id 1 y edad 20, y dos
// eventos en la agenda la función imprimirá: "Persona 1: Persona1, 20 años
...
// La función es Theta(n) peor caso, siendo n la cantidad de eventos en la
// agenda de la persona PRE: el evento está en la agenda de la persona
