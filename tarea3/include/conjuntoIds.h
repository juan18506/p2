...
// identificadores que almacena Los identificadores que almacena el conjunto
...
// La funcion es Theta(n) peor caso, siendo n la cantidad máxima de elementos
// del conjunto
...
// Si "id" no pertenece al rango válido de ids del conjunto "c" la función no
// hace nada La función es Theta(1) peor caso
...
// Deben imprimirse solamente los elementos, separados por un espacio, con un
// salto de línea al final Ejemplo: si el conjunto "c" tiene los elementos 7,
// 29, 42 y 75 la impresión debe ser "7 29 42 75 " La función es Theta(n) peor
// caso, siendo "n" la cantidad máxima de elementos de "c"
