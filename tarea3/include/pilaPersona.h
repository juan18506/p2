...
// La funcion es O(n*m) peor caso, siendo n la cantidad de elementos en 'p' y m
...
// La funcion es Theta(m) peor caso, donde m es la cantidad de eventos de la
// agenda de 'persona'.
...
// La funcion es Theta(m) peor caso, donde m es la cantidad de eventos de la
// agenda de la persona que se desapila.
