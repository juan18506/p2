/*
  ...
  Los elementos de tipo TColaPersonasABB son colas de elementos de tipo
  TPersonasABB.
...
// Libera la memoria asignada a 'c' y la de todos sus elementos pero sin liberar
// la memoria de los elementos de tipo TPersonasABB incluidos. La función es
// Theta(n) peor caso, donde n es la cantidad de personas en la cola.
...
// Se libera la memoria asignada al elemento de la cola pero sin liberar la
// memoria del elemento de tipo TPersonasABB incluido. Precondición:
// cantidadEnCola(c) > 0. La función es Theta(1) peor caso.
