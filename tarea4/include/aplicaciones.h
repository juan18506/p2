...
/*
  ...
  El tiempo de ejecución en promedio es O(n*log n+ n*m), siendo 'n' la cantidad
  de nombres y 'm' es la cantidad de eventos de la agenda con mas eventos entre
  todas las personas de la tabla. Se debe utilizar una cola de prioridad
  auxiliar para resolver el problema.
 */
